...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Forgot Password
    if (isset($_POST['forgot_submit']) && isset($_POST['forgot_nonce']) && wp_verify_nonce($_POST['forgot_nonce'], 'forgot_password')) {
        $forgot_email = sanitize_email($_POST['forgot_email']);
        if (!email_exists($forgot_email)) {
            ...
            if (wp_mail($forgot_email, $subject, $message, $headers)) {
...
<div class="login-container">
    ...
    <div class="login-row">
        ...
        <div class="login-box">
            ...
            <?php if (isset($forgot_success)) echo '<p class="success-msg">'.$forgot_success.'</p>'; ?>
            <?php if (isset($forgot_error)) echo '<p class="error-msg">'.$forgot_error.'</p>'; ?>
            ...
            <form method="post" id="login_form" style="display: block;">
            ...
            <div style="text-align:right; margin-top:10px;">
                <a href="/lost-password" id="show_forgot" style="font-size:14px;">Forgot your password?</a>
            </div>
            </form>

            <form method="post" id="forgot_form" style="display: none;">
            ...
            <div style="text-align:right; margin-top:10px;">
                <a href="#" id="back_to_login" style="font-size:14px;">Back to login</a>
            </div>
            </form>
        </div>
