<?php
/**
 * Template Name: Login ou Cadastre-se
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['login_submit']) && isset($_POST['login_nonce']) && wp_verify_nonce($_POST['login_nonce'], 'login_user')) {
        ...
        if (!is_wp_error($user)) {
            wp_set_current_user($user->ID); // Define o usuário atual
            wp_set_auth_cookie($user->ID, true); // Garante cookie persistente
    ...
    if (isset($_POST['register_submit']) && isset($_POST['register_nonce']) && wp_verify_nonce($_POST['register_nonce'], 'register_user')) {
        ...
        if (!email_exists($email)) {
            ...
            $register_error = 'Este e-mail já está cadastrado.';
        }
    }
}
...
<div class="login-container">
    <h2 class="login-title">🚀 Login ou Cadastre-se</h2>
    <div class="login-row">
        <!-- Login -->
        <div class="login-box">
            ...
            <form method="post">
                ...
                <div style="position: relative;">
                    <input type="password" name="login_password" placeholder="Senha" required id="login_password">
        ...
        <div class="login-box">
            ...
            <form method="post">
                ...
                <input type="text" name="register_name" placeholder="Nome completo" required>
                <input type="email" name="register_email" placeholder="E-mail" required>
                <div style="position: relative;">
                    <input type="password" name="register_password" placeholder="Senha" required id="register_password">
...
<script>
    document.querySelectorAll('.toggle-password').forEach(function(el) {
        el.addEventListener('click', function() {
            ...
            // Trocar o ícone (opcional: trocar emoji 👁️/🙈)
