        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-5">
                    <div><strong>OUR PRODUCTS</strong></div>
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 content-head">
                <div class="mbr-section-head mb-5">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Mobility Scooters</strong></h4>
                    <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-4 display-7">
                        We offer safe and powerful scooters to make it easier for you to get around the parks.
                        <div>&nbsp;• Long-lasting battery</div>
                        <div>&nbsp;• Padded and comfortable seat</div>
                        <div>&nbsp;• Intuitive and easy-to-operate controls</div>
                        <div><br></div>
                    </h5>
                </div>
            </div>
                ...
                <div class="item features-image col-12 col-md-6 col-lg-3 active">
                    <div class="item-wrapper">
                        ...
                        <div class="item-content align-items-center">
                            ...
                            <div class="mbr-section-btn item-footer"><a href="<?php the_permalink(); ?>" class="btn item-btn btn-primary display-7">Rent</a></div>
                        </div>
                    </div>
                </div>
            <?php endwhile;
...
<section data-bs-version="5.1" class="features4 start cid-uGB3WNprXn" id="features04-1h">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 content-head">
                <div class="mbr-section-head mb-5">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Baby Strollers</strong></h4>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
